- Важно отметить, что это задание направлено не на подготовку действительно рабочей модели, а на оценку логичного и верного прохождения этапов анализа данных.
